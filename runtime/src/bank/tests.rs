...
fn test_compute_active_feature_set() {
    ...
    let (feature_set, new_activations) = bank.compute_active_feature_set_including_pending();
    ...
    let (_feature_set, new_activations) = bank.compute_active_feature_set_including_pending();
