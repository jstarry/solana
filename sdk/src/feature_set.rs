...
pub mod stakes_remove_rent_delinquent_accounts {
    solana_sdk::declare_id!("CJdJL1osdEQkfCeSqGFK1nXrmxZy4hwKK5ngfLwbHhd4");
}
...
lazy_static! {
    ...
    pub static ref FEATURE_NAMES: HashMap<Pubkey, &'static str> = [
        ...
        (stakes_remove_rent_delinquent_accounts::id(), "remove rent delinquent accounts from stakes cache"),
