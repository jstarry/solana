...
// 1 - num accounts
// 1 - num signers
// 1 - num readonly signers
// 1 - num readonly nonsigners
// 1 - num instructions
// 1 - num address maps
// 32 - recent blockhash
// 32 * N - account keys
...
// address maps
// 1 - num readonly indexes
// 1 - num writable indexes
// W + R - 1 byte for each account index

// compiled instructions
// 1 - program index
// 1 - num account inputs
// 1 or 2 - data length
// A - 1 byte for each account index

// ideas
// put all account indexes for instructions at the end
// put all account indexes for address maps together
// block off 255 as a MARKER for no more or use extra byte to indicate short batch
