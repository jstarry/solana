...
pub mod tests {
    ...
    fn test_process_blockstore_with_invalid_slot_tick_count() {
        ...
        assert_eq!(bank_forks.read().unwrap().highest_frozen_bank().slot(), 2);
    ...
    fn test_process_blockstore_with_two_forks() {
        ...
        */
        ...
        assert_eq!(bank_forks.highest_frozen_bank().slot(), 4);
    ...
    fn test_process_blockstore_with_dead_slot() {
        ...
        */
        ...
        assert_eq!(bank_forks.highest_frozen_bank().slot(), 3);
        assert_eq!(
            &bank_forks[3]
                .parents()
                .iter()
    ...
    fn test_process_ledger_simple() {
        ...
        assert_eq!(bank_forks.highest_frozen_bank().slot(), 1);
    ...
    fn test_process_blockstore_from_root() {
        ...
        */
        ...
        assert_eq!(bank_forks.highest_frozen_bank().slot(), 6);
